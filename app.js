...
function ready(){
    ...
    //Agregor funcionalidad a los botones Agregar al Carrito
...
function actualizarTotalCarrito(){
    ...
    for(var i=0; i < carritoItems.length; i++){
        ...
        //quitamos el simnbolo peso y el punto de milesimo
...
function agregarAlCarritoClicked(event){
    ...
    //La siguiente funciion agrega el elemento al carrito. Le mando por parámetros los valores
...
function pagarClicked(event){
    ...
    var carritoItems = document.getElementsByClassName('carrito-items') [0];
    while(carritoItems.hasChildNode()){
